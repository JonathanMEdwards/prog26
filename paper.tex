...
Baseline is foremost an interactive programming system that must be evaluated in terms of usability. The playable demo discussed in Appendix~\ref{demo} is a first step in that direction. We evaluate and situate the design of Baseline in Appendix~\ref{tech-dims} using the \textit{Technical Dimensions of Programming Systems}~\cite{techdims} framework.
