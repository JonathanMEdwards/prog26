...
\end{tikzcd}
\]
in other words, projection produces a fixpoint. The \textbf{Roundtrip Monotonicity} principle is that (a) \mathbox{\leq} is a partial order, and (b) roundtripping a timeline through a projection and retraction or the reverse results in a timeline $\leq$ the original.



\subsection{Optimal branchless diffing}
free range version control
open world version control
% beyond the repo
