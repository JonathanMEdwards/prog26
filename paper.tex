...
% Calling this section Evaluation makes the latexdiff better
% If only there was a more accurate way to do diffing :(
\section{Evaluation}\label{discussion}

\textcolor{red}{Need to add variations to the 3 Extract Entity problems}

\textcolor{red}{Summarize case study results here?}

\textcolor{red}{Discuss 4 failed challenge problems as case studies here?}
