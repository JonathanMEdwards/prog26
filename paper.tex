...
We need further work to settle on the best set of operations for schema evolution in nested relations. Because of the deduping anomalies mentioned earlier we want to implement a proper set datatype that automatically collapses duplicates into equivalence classes.
