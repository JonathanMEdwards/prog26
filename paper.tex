...
% On the other hand, most OT and all CRDT algorithms are decentralized, whereas we are not: we can automatically synchronize replicas, but only if one of them is designated as a \textit{primary} serializing all transfers.
