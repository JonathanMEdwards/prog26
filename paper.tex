...
As noted previously, implementing projection and retraction rules in code has proven impractical. We plan to build a DSL for specifying rules succinctly by exploiting their inherent symmetries.

We need further work to settle on the best set of operations for schema evolution in nested relations, which appears to be a blind spot in prior research.
