...
\begin{abstract}
  ...
  Baseline is a platform for richly structured data supporting change in multiple dimensions: mutation over time, collaboration across space, and evolution through design changes. It is built upon \textit{Operational Differencing}, a new operation-based technique for managing data in terms of high-level operations including refactorings and schema changes. We use operational differencing to construct an operation-based form of version control over data structures from programming languages and relational databases.
