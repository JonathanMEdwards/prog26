...
In response to points 1, 3, & 4 we have substantially expanded and restructured the evaluation aspects of the paper. Before there was an Evaluation section that tabulated the eight challenge problems identified in our prior paper (Schema Evolution in Interactive Programming Systems), assigning a Pass/Fail grade to each. Now we have distributed discussion of case studies throughout the paper that include more nuanced evaluations. These vase studies include the four challenge problems that were deemed to have been solved, but also additional cases taken from the research literature that reveal more comprehensively the current capabilities and limitations of Baseline. A combined Evaluation and Discussion section now discusses the cases of the four failed challenge problems.
