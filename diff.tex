...
%DIF ADD paper.tex                Fri Feb 27 14:07:32 2026
...
%DIFDELCMD < %%%
\DIFdel{We judge that we have solved four of the eight challenge problems. The remaining four are goals for future work. }\DIFdelend \DIFaddbegin \DIFadd{Baseline is foremost an interactive programming system that must be evaluated in terms of usability. The playable demo discussed in Appendix~\ref{demo} is a first step in that direction. We evaluate and situate the design of Baseline in }\DIFaddend Appendix~\ref{tech-dims} \DIFdelbegin \DIFdel{contains an evaluation of Baseline }\DIFdelend using the \textit{Technical Dimensions of Programming Systems}~\cite{techdims} framework.
