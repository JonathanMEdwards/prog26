...
%DIF ADD paper.tex                Thu Mar  5 10:46:05 2026
...
\cite{challenge-problems}}\hskip0pt%DIFAUXCMD
. We have already discussed four of these challenge problems in case studies \ref{case-multiplicity}, \ref{case-extract}, \ref{case-diverge}, and \ref{case-query}. The other four challenge problems present difficulties, as follows.
}\DIFaddend 
...
\cite{challenge-problems} }\hskip0pt%DIFAUXCMD
all require programming language capabilities that are beyond the current scope of Baseline.
}\end{casestudy}
\DIFaddend 
...
\DIFaddbegin \DIFadd{Much of the work on Baseline has been on its user interface, and especially how to visualize structural differences. Unfortunately space limitations have prevented us from discussing this work, which is summarized in Appendix~\ref{UI}.
Ultimately Baseline must be judged in terms of usability.
The playable demo described in Appendix~\ref{demo} has provided some initial feedback and could become the basis of a controlled experiment.
